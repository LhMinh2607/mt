...
export const drinkFeatureListReducer = (state={}, action)=>{
    switch(action.type){
        case DRINK_SHOW_FEATURE_REQUEST:
            return {loading: true};
        case DRINK_SHOW_FEATURE_SUCCESSFUL:
            return {loading: false, drinkIds: action.payload};
        case DRINK_SHOW_FEATURE_FAILED:
            return {loading: false, error: action.payload};
        case DRINK_SHOW_FEATURE_RESET:
            return {};
        default:
            return state;
    }
...
export const suggestedDrinkListReducer = (state={}, action)=>{
    switch(action.type){
        case DRINK_SUGGESTED_REQUEST:
            return {loading: true};
        case DRINK_SUGGESTED_SUCCESSFUL:
            return {loading: false, suggestedDrinks: action.payload};
        case DRINK_SUGGESTED_FAILED:
            return {loading: false, error: action.payload};
        default:
            return state;
    }
