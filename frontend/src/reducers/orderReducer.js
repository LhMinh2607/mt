...
export const drinkOrderedCountReducer = (state = {}, action)=>{
    switch(action.type)
    {
        case COUNT_ORDERED_DRINK_REQUEST:
            return {loading: true};
        case COUNT_ORDERED_DRINK_SUCCESSFUL:
            return {loading: false, orderedDrinkCount: action.payload};
        case COUNT_ORDERED_DRINK_FAILED:
            return {loading: false, error: action.payload};
        default:
            return state;
    }    
...
export const orderIncomePerMonthListReducer = (state = {incomePerMonthList: []}, action)=>{
    switch(action.type){
        case ORDER_INCOME_PER_MONTH_LIST_REQUEST:
            return {loading: true};
        case ORDER_INCOME_PER_MONTH_LIST_SUCCESSFUL:
            return {loading: false, incomePerMonthList: action.payload};
        case ORDER_INCOME_PER_MONTH_LIST_FAILED:
            return {loading: false, error: action.payload};
        default:
            return state;
    }
